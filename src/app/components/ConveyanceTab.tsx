        ...
        <div className="relative z-20 bg-white/70 backdrop-blur-lg rounded-2xl p-4 shadow-xl border border-white/50">
          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
            ...
            <button
              ...
              disabled={false}
              className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold text-sm px-6 py-2.5 rounded-xl transition-all shadow-lg flex items-center justify-center gap-2 border-none hover:from-blue-600 hover:to-indigo-700 hover:shadow-xl transform hover:scale-105"
            >
              <svg
                className="w-5 h-5"
                fill="none"
