...
interface LoginModalWhiteProps {
  isOpen: boolean;
  onClose: () => void;
  onSwitchToSignup: () => void;
}

export default function LoginModalWhite({
  isOpen,
  onClose,
  onSwitchToSignup,
}: LoginModalWhiteProps) {
        ...
        <div className="mt-6">
          ...
          <div className="mt-4 grid grid-cols-1 gap-3">
            <button
              ...
              disabled={loading}
              className="w-full bg-white hover:bg-gray-50 disabled:bg-gray-100 disabled:cursor-not-allowed text-gray-700 font-medium py-3 px-4 rounded-xl transition-all flex items-center justify-center space-x-2 border border-gray-300 hover:border-gray-400"
            >
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-gray-900 hover:bg-black disabled:bg-gray-700 disabled:cursor-not-allowed text-white font-medium py-3 px-4 rounded-xl transition-all flex items-center justify-center space-x-2 border border-gray-900"
            >
              <span>{loading ? "Continuing..." : "Continue as Guest"}</span>
            </button>
          </div>
        </div>
