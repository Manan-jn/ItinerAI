            ...
            <div
              className={`tab-content-area overflow-hidden ${
                tab.isMinimized
                  ...
                  : "max-h-[600px] opacity-100 py-1"
              }`}
              style={{
                transition:
                  "max-height 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94), opacity 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94), padding 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94)",
              }}
            >
