...
async def merge_dict_intelligently(
    ...
    try:
        ...
        for key, new_value in new.items():
            ...
            if key not in merged:
                ...
                merged[key] = await merge_dict_intelligently(merged[key], new_value)
            else:
                merged[key] = new_value

        return merged
    except Exception as e:
        logger.error("Error in merge_dict_intelligently", exc_info=True)
